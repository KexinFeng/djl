...
public final class GPTInference {
    ...
    private static void testPtGreedy()
        ...
        // It calls GPT2PtLMBlock.java which is engine specific, whose package `pytorch-engines.main` cannot be loaded here.
        ...
        // to make LMSearch integrate AbstractBlock so that it will be wrapped in a Model and utilizes the translator
    ...
    private static void testOnnx()
        ...
        try (ZooModel<NDList, NDList> model = criteria.loadModel();
            ...
            System.out.println(tokenizer.decode(inputIds));
        }
    }
